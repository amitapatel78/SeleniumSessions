...
//			//sel_indus.selectByIndex(5); // Ex when we need to select month - like when values are static
//			sel_indus.selectByVisibleText("Automotive");// most of the time we use byvisibletext
...
//			doSelectDropDownByValue(industry, "media");
			...
			// to check drop down is multi select drop down or single select drop down
