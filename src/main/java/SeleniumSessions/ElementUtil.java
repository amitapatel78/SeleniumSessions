...
//why  we removing static from each method
//because we not using classname.method name we are passing in to the constructor of this class as a driver
//we calling internally this methods by creating the object of this ElementUtil class
